...
-- procedures for showing the pending requests
drop procedure if exists showEditRequests;
delimiter //
create procedure showEditRequests()
begin
...
drop procedure if exists showArticleRequests;
delimiter //
create procedure showArticleRequests()
begin
...
drop procedure if exists showKeywordRequests;
delimiter //
create procedure showKeywordRequests()
begin
...
drop procedure if exists showPaperRequests;
delimiter //
create procedure showPaperRequests()
begin
...
drop procedure if exists showDeleteRequests;
delimiter //
create procedure showDeleteRequests()
begin
...
begin
    ...
    if sql_error = false then
		commit;
        select 'Article was successfully added to database.';
	else
		rollback;
        select 'Article was not added to database.';
	end if;
...
begin
    ...
    if sql_error = false then
		commit;
        select 'Article and author were successfully added to database.';
	else
		rollback;
        select 'Article and author were not added to database.';
	end if;
end//
...
begin
	...
	if sql_error = false then
		commit;
		select 'Paper was successfully added to database.';
	else 
		rollback;
        select 'Paper was not added to database.';
	end if;
end//
delimiter ;
...
begin
	...
	if sql_error = false then
		commit;
        select 'Paper and author were successfully added to database.';
	else
		rollback;
        select 'Paper and author were not added to database.';
	end if;
end//
...
begin
	...
	if sql_error = false then
		commit;
        select 'Paper, author, and journal were successfully added to database.';
	else
		rollback;
        select 'Paper, author, and journal were not added to database.';
	end if;
end//
...
begin
	...
	if sql_error = false then
		commit;
		select 'Paper and journal were successfully added to database.';
	else 
		rollback;
        select 'Paper and journal were not added to database.';
	end if;
end//
